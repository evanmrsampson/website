function revealHeader()
{
    ...
    loading.style.animation = "fadeOutHeader ease-in 4s 1";
    loading.style.opacity = 0;
    var headerImage = header.getElementsByTagName("img")[0];
    headerImage.style.animation = "fadeInHeader ease-in 4s 1";
    headerImage.style.opacity = 0.75;
    var titles = header.getElementsByClassName("titles")[0];
    titles.style.animation = "fadeInTitle ease-in 5s 1";
